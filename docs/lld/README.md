...
| 8     | Removed by ADR 0004            | External policy/approval/action execution is outside the product                                         |
| 9     | `09-review-interface.md`       | Prompt-first conversation, activity timeline, document viewer, findings, and conflict handling           |

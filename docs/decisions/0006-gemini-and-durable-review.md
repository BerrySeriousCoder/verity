...
Status: accepted provider choice; implementation undergoing acceptance testing.
...
Unit and PostgreSQL tests cover parser boundaries, source ownership, fabricated citations, omitted source blocks, scope pausing, batched answers, stale leases, and cancellation. Browser tests cover original-source navigation and findings. Live Gemini validation remains pending local credentials.
